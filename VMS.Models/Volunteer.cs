...
namespace VMS.Models
{
    public class Volunteer
    {
        ...
        [Required] [MaxLength(25)] public string UserName { get; set; }
        ...
        [Required] public string VolunteerPrefersCenter { get; set; }
        ...
        [Required] public string EmergencyContactCellPhone { get; set; }

        [EmailAddress] public string EmergencyContactEmail { get; set; }
        public bool IsDriversLicenseOnFile { get; set; }
        public bool IsSsCardOnFile { get; set; }

        [Required] public bool IsActive { get; set; }

        [Required] public string ApprovalStatus { get; set; }
    }
}